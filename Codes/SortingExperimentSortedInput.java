...
public class SortingExperimentSortedInput {
    ...
    public static void main(String[] args) {
        ...
        String runLabel = "First Run (Sorted Input)";  // Change this label for each run

        try (PrintWriter csvWriter = new PrintWriter(new FileWriter("sorting_experiment_sorted_input_results.csv", true))) {  // Open in append mode
            ...
            for (int size : sizes) {
                ...
                // Create an already sorted array of the specified size
                Integer[] array = new Integer[size];
                for (int i = 0; i < size; i++) {
                    array[i] = i;  // Already sorted integers
                }

                // Test each sorting algorithm on the current sorted array
            ...
            System.out.println("Results for " + runLabel + " written to sorting_experiment_sorted_input_results.csv");
