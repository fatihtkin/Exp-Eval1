...
public class SortingExperiment {
    ...
    public static void main(String[] args) {
        ...
        // Random number generator for creating random integer arrays
        ...
        String runLabel = "Third Run";  // Change this label for each run

        try (PrintWriter csvWriter = new PrintWriter(new FileWriter("sorting_experiment_results.csv", true))) {  // Open in append mode
            ...
            for (int size : sizes) {
                ...
                // Create a new array of the specified size with random integers
                Integer[] array = new Integer[size];
                for (int i = 0; i < size; i++) {
                    array[i] = random.nextInt();  // Fill array with random integers
                }

                // Test each sorting algorithm on the current random array
            ...
            System.out.println("Results for " + runLabel + " written to sorting_experiment_results.csv");
